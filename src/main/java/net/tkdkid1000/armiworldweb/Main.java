...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Database.runCommand("CREATE TABLE IF NOT EXISTS users (email text NOT NULL,username text NOT NULL,password text NOT NULL,icon text DEFAULT \"https://purr.objects-us-east-1.dream.io/i/20160824_163745-1.jpg\",reputation integer DEFAULT 1,role TEXT DEFAULT 'default');");
